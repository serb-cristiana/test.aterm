...
<body><?php
include 'meniu.php';
//$dateLucrare = $conbd->query("SELECT  ID,  Parinte,  IDClient,  CuMontaj,    CodIntern,  CodIntern2,  NumeClient,  Nume,  Valoare,  Responsabil,  Descriere,   Suprafata,  Greutate,  Ferestre,  Usi,    DataCreare,   DataLivrare,   AdresaLivrare,  TraseuLivrare,  Stadiu  FROM comenzi WHERE ID > 0  ".$filtruComenzi."   ORDER BY Parinte DESC, CodIntern2 DESC;");
...
$sqlStr = "SELECT 
  ...
  WHERE co.ID > 0 AND co.Anulata = 1 
  ".$filtruComenzi."    
